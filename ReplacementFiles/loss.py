...
def giou_loss(pred, target, eps=1e-7):
    ...
    enc_area = (enc_x2 - enc_x1) * (enc_y2 - enc_y1) + eps
...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask):
        ...
        giou = giou_loss(pred_bboxes[fg_mask], target_bboxes[fg_mask]) #giou implemented from ahg paper
        loss_iou = (giou * weight).sum() / target_scores_sum
