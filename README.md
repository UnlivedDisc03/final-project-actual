...
To perform metric analysis such as: MOTA, IDF1, MOTP; the motmetrics module needs to be cloned from: https://github.com/cheind/py-motmetrics and only works with the TomatoesMixedTRIM.mp4 video.
